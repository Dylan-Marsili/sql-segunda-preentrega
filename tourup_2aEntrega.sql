...
BEGIN
	...
	DECLARE tourup_commission_base DECIMAL(10,2);
	...
	INTO tourup_commission_base
	FROM experiencias_tours AS ex
		INNER JOIN ventas AS v ON (v.id_experience = ex.id_experience)
    WHERE v.id_sale_transaction = NEW.id_sale_transaction;
    
    SET NEW.commission_agreed = tourup_commission_base;
    
    SET total_payment = total_sale - ((tourup_commission_base/100) * total_sale);
...
VALUES  (NULL, 'Gabriela Morales', '7775896412', 'gabriela@tourup.com', 'Paseo del conquistador #403 Colonia Las Haciendas', 'MOSA854697235', 35000, 'BBVA', '258963147854', '2021-02-01', 10, 1),
		(NULL, 'José García', '5557778888', 'jose@tourup.com', 'Avenida de los Trabajadores #105 Colonia Centro', 'GARJ852369741', 7000, 'Bancomer', '123654789012', '2021-02-01', 1, 2),
		(NULL, 'Laura Martínez', '5551234567', 'laura@tourup.com', 'Calle de las Flores #23 Colonia Primavera', 'MARL369852147', 8000, 'Bancomer', '789123456789', '2021-02-01', 3, 3),
		(NULL, 'Carlos Hernández', '5556667777', 'carlos@tourup.com', 'Calle del Sol #12 Colonia Aurora', 'HECA741258963', 7000, 'Banamex', '456789123456', '2021-02-01', 6, 4),
		(NULL, 'Ana Ramírez', '5557778888', 'ana@tourup.com', 'Calle de la Luna #45 Colonia Luna Nueva', 'RAAN963741852', 7000, 'Santander', '789456123789', '2021-02-01', 6, 5),
		(NULL, 'Diego Martínez', '5557779999', 'diego@tourup.com', 'Avenida del Bosque #67 Colonia Bosques del Sur', 'MADI852369741', 10000, 'Banorte', '147258369147', '2021-02-01', 1, 6),
		(NULL, 'María González', '5553334444', 'maria@tourup.com', 'Calle de la Montaña #89 Colonia Vista Hermosa', 'GOMA369852147', 15000, 'Santander', '987654123987', '2021-02-01', 1, 7),
		(NULL, 'Juan Pérez', '5556661111', 'juan@tourup.com', 'Calle de los Ingenieros #34 Colonia Tecnológica', 'PEJU852369741', 9000, 'HSBC', '369258147852', '2021-02-01', 5, 8),
		(NULL, 'Laura Gutiérrez', '5558889999', 'laura.g@tourup.com', 'Avenida de la Naturaleza #56 Colonia La Sierra', 'GULA963852741', 11000, 'BBVA', '987654321654', '2021-02-01', 2, 9),
		(NULL, 'Pedro Hernández', '5552223333', 'pedro.h@tourup.com', 'Calle del Río #78 Colonia del Bosque', 'HEPE963852741', 13000, 'Bancomer', '852963741852', '2021-02-01', 2, 10),
		(NULL, 'María López', '5555555555', 'maria.l@tourup.com', 'Avenida de los Pinos #90 Colonia de los Árboles', 'LOMA963852741', 14000, 'BBVA', '123456789654', '2021-02-01', 2, 11),
		(NULL, 'Javier Rodríguez', '5553334444', 'javier@tourup.com', 'Calle de las Aves #12 Colonia del Sol', 'ROJA963852741', 16000, 'Santander', '789456123987', '2021-02-01', 2, 12),
		(NULL, 'Fernando Díaz', '5556667777', 'fernando@tourup.com', 'Calle de las Flores #23 Colonia Primavera', 'DIFE963852741', 20000, 'Bancomer', '321654987321', '2021-02-01', 3, 13),
		(NULL, 'Carmen González', '5552223333', 'carmen@tourup.com', 'Calle de los Ángeles #45 Colonia Cielo Azul', 'GOCG963852741', 25000, 'BBVA', '987654321789', '2021-02-01', 1, 14),
		(NULL, 'Roberto Sánchez', '5558889999', 'roberto@tourup.com', 'Avenida del Trabajo #67 Colonia Centro', 'SARO963852741', 10000, 'Banamex', '456987321654', '2021-02-01', 1, 15),
		(NULL, 'Laura Martínez', '5551234567', 'laura.m@tourup.com', 'Calle del Trébol #89 Colonia Arcoiris', 'MALA963852741', 12000, 'BBVA', '789654321987', '2021-02-01', 1, 16),
		(NULL, 'María Pérez', '5557779999', 'maria.p@tourup.com', 'Calle de las Rosas #12 Colonia Jardín', 'PEMA963852741', 10000, 'Bancomer', '369258147852', '2021-02-01', 3, 17),
		(NULL, 'Diego Gómez', '5554445555', 'diego.g@tourup.com', 'Avenida de las Estrellas #34 Colonia Los Alamos', 'GODI963852741', 12000, 'BBVA', '987654321147', '2021-02-01', 4, 18),
		(NULL, 'Ana Rodríguez', '5558889999', 'ana.r@tourup.com', 'Calle de la Luna #67 Colonia Lunas', 'ROAN963852741', 15000, 'Santander', '123456789654', '2021-02-01', 4, 19),
		(NULL, 'Sofía García', '5556667777', 'sofia@tourup.com', 'Calle de las Nubes #12 Colonia Cielo', 'GASO963852741', 12000, 'HSBC', '321654987987', '2021-02-01', 5, 20),
		(NULL, 'Miguel López', '5551112222', 'miguel@tourup.com', 'Calle del Trueno #34 Colonia Tormenta', 'LOMI963852741', 14000, 'Banorte', '789456123321', '2021-02-01', 6, 21),
		(NULL, 'Laura Torres', '5559990000', 'laura.t@tourup.com', 'Calle del Río #56 Colonia del Sol', 'TOLA963852741', 16000, 'BBVA', '987654321456', '2021-02-01', 3, 22),
		(NULL, 'Juan Martínez', '5554445555', 'juan.m@tourup.com', 'Avenida de los Árboles #78 Colonia Arboledas', 'MAJU963852741', 15000, 'Banamex', '369258147369', '2021-02-01', 2, 23);
